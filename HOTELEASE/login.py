...
class Login_Window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\h.png.avif")
        ...
        img1=Image.open(r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\l.png.jpg")
        ...
        img2=Image.open(r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\user.png.jpg")
        img2=img2.resize((25,25))
        self.photoimg2=ImageTk.PhotoImage(img2)
        lblimg1=Label(image=self.photoimg2,bg="black",borderwidth=0)
        lblimg1.place(x=650,y=323,width=25,height=25)
        
        img3=Image.open(r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\pass.png.png")
        ...
        # Forget Password
        registerbtn=Button(frame,text="Forget Password",command=self.forgot_password_window,font=("times new roman",10,"bold"),bd=3,borderwidth=0,fg="white",bg="black",activeforeground="white",activebackground="black")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpassword.get()=="":
        ...
        elif self.txtuser.get()=="rishi" and self.txtpassword.get()=="risi":
            ...
            if row==None:
                ...
                if open_main>0:
                    self.new_window=Toplevel(self.root)
                    self.app=HotelEase(self.new_window)
                else:
                    if not open_main:
                        return
            conn.commit()
...
# ================= forget password window =====================
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                messagebox.showerror("Message","Please enter the valid username")
            else:
                conn.close()
                self.root2=Toplevel()
                ...
                self.combo_security_Q["value"]=("Select","Your first school name","Your birth city name","Your dream job name","Your favorite food name","Your fevorite place name")
...
class Register:
    def __init__(self,root):
        ...
        #  bg Image
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\bg.png.png")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)
        
        
        # left image
        self.bg1=ImageTk.PhotoImage(file=r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\rg.png.avif")
        ...
        combo_security_Q["value"]=("Select","Your first school name","Your birth city name","Your dream job name","Your favorite food name","Your fevorite place name")
        ...
        # button 
        img1=Image.open(r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\rb.png.jpg")
        img1=img1.resize((200,55))
        self.photoimg1=ImageTk.PhotoImage(img1)

        b1=Button(frame,image=self.photoimg1,command=self.register_data,borderwidth=0,cursor="hand2",font=("times new roman",15,"bold"),fg="white",bg="white")
        b1.place(x=10,y=420,width=200)
        
        img2=Image.open(r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\lb.png.jpg")
        img2=img2.resize((200,45))
        self.photoimg2=ImageTk.PhotoImage(img2)

        b2=Button(frame,image=self.photoimg2,command=self.return_login,borderwidth=0,cursor="hand2",font=("times new roman",15,"bold"),fg="white")
...
# =============================== title ========================================
        lbl_title=Label(self.root,text="HOTELEASE",font=("times new roman",40,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
...
# ========================================== right side image ===============================================================
        img3=Image.open(r"C:\Users\mahur\OneDrive\Desktop\HOTELEASE\images\hotel2.png.avif")
